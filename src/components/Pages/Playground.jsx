...
//   const totalProblems = 810 + 151 + 120 + 110 + 50; 
  
//   const stats = [
//     { value: `${totalProblems}+`, label: 'Problems Solved', icon: <Code size={24} /> },
//     { value: '350+', label: 'Total Active Days', icon: <Clock size={24} /> },
//     { value: '150+', label: 'Current Streak', icon: <Zap size={24} /> },
//     { value: '60+', label: 'Total Contests', icon: <Trophy size={24} /> },
//   ];
...
//     { rank: "Global 1179", event: "LeetCode Biweekly Contest 479", detail: "Top International Rank" },
//     { rank: "1856*", event: "LeetCode Rating", detail: "Competitive Edge" },
//     { rank: "3★", event: "CodeChef", detail: "Rated Competitive Programmer" }
//   ];
...
//             {/* LeetCode Stats Card */}
// <div className="relative w-full mb-4 overflow-hidden rounded-xl border border-gray-700 bg-gray-900 p-2">
//   <img
//     src="https://leetcard.jacoblin.cool/codee_runn?theme=forest&font=Crete%20Round&ext=contest"
//     alt="LeetCode Stats"
...
export default function PlaygroundPage() {
  ...
  const competitionStats = [
    { rank: "13+", event: "Awards Won", detail: "Across LeetCode, CodeChef, HackerRank", icon: "🏅" },
    { rank: "AIR 401", event: "Meta Hacker Cup 2025", detail: "Global Rank 2244" },
    { rank: "AIR 115", event: "Amazon ML Challenge 2025", detail: "Among 6,000+ teams" },
    { rank: "Global 1179", event: "LeetCode Biweekly Contest 479", detail: "Top International Rank" },
    { rank: "1856*", event: "LeetCode Rating", detail: "Competitive Edge" },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            <div
              key={stat.label}
              className="bg-gray-800 p-6 rounded-xl border border-gray-700 hover:border-cyan-500 transition-all duration-300 shadow-lg hover:shadow-cyan-500/30 transform hover:scale-[1.02]"
              style={{ background: 'linear-gradient(145deg, #1f2937, #111827)' }}
            >
              <div className={`text-4xl font-extrabold mb-1 bg-clip-text text-transparent bg-gradient-to-r ${
                index % 2 === 0
        ...
        {/* --- Activity Streaks Section --- */}
        <h2 className="text-3xl font-bold text-gray-200 mb-8 mt-12">
          Activity Streaks
        </h2>

        {/* ONLY LEETCODE STATS */}
        <div className="max-w-3xl mx-auto mb-16 bg-gray-800 p-6 rounded-2xl border border-gray-700 shadow-xl">

          <h3 className="text-2xl font-semibold mb-4 text-purple-400 flex items-center gap-2">
            <Trophy size={20} /> LeetCode Live Stats
          </h3>

          <p className="text-gray-400 mb-4">
            Real-time LeetCode performance including rating, contests and solved problems.
          </p>

         <div className="flex justify-center">
  <div className="w-full max-w-md overflow-hidden rounded-xl border border-gray-700 bg-gray-900 p-2">
    <img
      src="https://leetcard.jacoblin.cool/codee_runn?theme=forest&font=Crete%20Round&ext=contest"
      alt="LeetCode Stats"
      className="w-full rounded-lg"
    />
          ...
          <a
            href="https://leetcode.com/u/codee_runn/"
            target="_blank"
        ...
        {/* --- Platform Breakdown and Achievements --- */}
        <h2 className="text-3xl font-bold text-gray-200 mb-8 mt-12">
          Coding Profiles with Breakdown
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            {competitionStats.map((achievement, index) => (
              <div
                key={index}
                className="bg-gray-800 p-4 rounded-xl border-l-4 border-yellow-500 shadow-md"
              >
